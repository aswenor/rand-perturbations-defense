# -*- coding: utf-8 -*-
"""Increased_Randomness.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fxEVAQ7WViXkqJ2BXaB7lGeNcpY6Q_il
"""
...
# Setup results file
res_file = open("/content/gdrive/MyDrive/more_random_results.txt", mode='a')

# Get the specified input file
if data_to_use == "BAE":
  filename = "/content/gdrive/MyDrive/Perturbed_Data/BAEGarg2019_perturbed_data.txt"
elif data_to_use == "BAE_100":
  filename = "/content/gdrive/MyDrive/Perturbed_Data/BAEGarg2019_100_data.txt"
elif data_to_use == "DeepWordBug":
  filename = "/content/gdrive/MyDrive/Perturbed_Data/DeepWordBugGao2018_100_data.txt"
elif data_to_use == "FasterGeneticAlgo":
  filename = "/content/gdrive/MyDrive/Perturbed_Data/FasterGeneticAlgo_100_data.txt"
elif data_to_use == "Kuleshov":
  filename = "/content/gdrive/MyDrive/Perturbed_Data/Kuleshov2017_100_data.txt"
elif data_to_use == "PWWS":
  filename = "/content/gdrive/MyDrive/Perturbed_Data/PWWSRen2019_100_data.txt"
elif data_to_use == "TextBugger":
  filename = "/content/gdrive/MyDrive/Perturbed_Data/TextBuggerLi2018_100_data.txt"
elif data_to_use == "TextFooler":
  filename = "/content/gdrive/MyDrive/Perturbed_Data/TextFoolerJin2019_100_data.txt"

# Writing name of attack being tested to the output file
res_file.write(f"\n\n-----------------------Attack Tested: {data_to_use}---------------------------\n")
res_file.write(f"Size of R^ (k): {k}\n")
...
for i in range(num_reviews):
  ...
  # Writing the original review to the results file and printing 
  res_file.write(f"Original Review: {review}\n")
  ...
  for i in range(k):
    ...
    if choice == 0:
      ...
      for tok in misspelled:
        ...
        print(f"SPELL CHECK: \'{token}\' TO \'{correction}\'")
        print(f"Modified Sentence {i}: {modified_sent}")
    ...
    # Synonym Substitution
      ...
      print(f"SYN SUB: \'{token}\' TO \'{synonym}\'")
      print(f"Modified Sentence {i}: {modified_sent}")  

    # Drop Word
    elif choice == 2:
      modified_sent = sentence.replace(token, " ")
      print(f"DROP WORD: \'{token}\'")
      print(f"Modified Sentence {i}: {modified_sent}")
  ...
  res_file.write(str(predictions))
  res_file.write("\n")
  ...
  # Writing the final prediction and the correct label to the output file
  res_file.write(f"\nPrediction: {final_prediction}   Correct Label: {correct_label}  Certainty: {certainty}\n\n")
  res_file.write("\n")
...
# Calculate the accuracy and certainty of the defended/undefended models
...
res_file.write(f"Accuracy: {accuracy}  # Correct: {correct}  Total: {total}\n")
res_file.write(f"Avg. Certainty: {avg_certainty} Correct Certainty: {correct_certainty}  Incorrect Certainty: {incorrect_certainty}\n\n")
res_file.close()